...
public class Main {
	...
	static void menu() {
		System.out.println();
		System.out.println("Введите 1, чтобы вывести массив случайных автомобилей");
		System.out.println("Введите 2, чтобы заполнить массив одинаковыми значениями случайного автомобиля");
	}
